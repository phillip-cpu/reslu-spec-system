...
test("meeting context auto-selects only one clearly dominant candidate", () => {
  const candidates: MeetingDestinationCandidate[] = [
    { kind: "project", id: "p1", label: "Smith", subtitle: null, client_event_id: "e1", duplicate_filed_minutes_id: null, confidence: 0.96, reasons: ["now"], meeting_type: "design_meeting" },
    { kind: "lead", id: "l1", label: "Jones", subtitle: null, client_event_id: null, duplicate_filed_minutes_id: null, confidence: 0.52, reasons: ["active"], meeting_type: "new_lead" },
  ];
