...
Stage 4 remains partial until one live call survives the same project, lead and
Office navigation, and the physical iPhone gesture/newest-message matrix passes.
...
This passes the Safari call-start recovery check. It does not yet prove a live
call remains connected through project, lead and Office route changes, so Stage
4 remains partial.
